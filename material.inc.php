...
$this->card_info = array(
  ...
  1 => array(
    ...
    array('name'=>'stethoscope', 'choice_description' => self::_('if you want to change the result of one die using the Stethoscope'), 'title' => clienttranslate('Stethoscope'), 'tooltip' => clienttranslate('Discard after a cracking attempt to change the result of any one die to any side you wish.')),
