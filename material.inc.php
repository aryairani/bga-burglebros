...
$this->card_info = array(
  CardType::CHARACTER => array(
    ...
    array('name'=>'rook2', 'choice_description' => self::_('a player token to trade places'), 'subhead' => clienttranslate('Mastermind'), 'title' => clienttranslate('The Rook'), 'ability' => clienttranslate('Disguise'), 'tooltip' => clienttranslate('You may spend your first action to trade places with any player. This does not count as entering the tile for either of you.')),
